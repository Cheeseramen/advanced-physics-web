...
const components = { h1: SectionTitle, h2: SubSectionTitle, LawBox, ExBox, SummaryBox, Solution, Result, DisplayMath, SummaryCard, SummaryGrid, SimKeyword, QuizMatch, PhetButton, SecretCat, SecretFormula }
