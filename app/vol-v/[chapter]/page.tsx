...
export default async function ChapterPage({ params }: Props) {
  ...
  const filePath = path.join(process.cwd(), 'content', 'vol-v', `${chapter}.mdx`)
  ...
  const { prev, next } = getAdjacentChapters(chapter, 'vol-v')
  ...
  return (
    <>
      ...
      />
      <PageNav prev={prev} next={next} basePath="vol-v" />
    </>
  )
}
